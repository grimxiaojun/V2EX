...
public class DealsFrgment extends Fragment {
    private MyRecyclerViewAdapter mAdapter;
    private List<Topic> nodesList = new ArrayList<>();
    private NodesCallBack nodesCallBack;
    private static DealsFrgment instance = null;
    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView recyclerView;

    public static DealsFrgment newInstance() {
        if (instance == null) {
            instance = new DealsFrgment();
        }
        return instance;
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new NodesHttpUtils().getNodesByTab(nodesCallBack, getContext(), "deals");
    }
